...
def products_view(request, category_slug=None):
    ...
    products = (
        Product.objects.all().select_related("category").prefetch_related("reviews")
    )
    ...
    for product in page_obj:
        ...
        avg_rating = (
            reviews.aggregate(models.Avg("review_rating"))["review_rating__avg"] or 0
        )
        ...
        products_data.append(
            {
                ...
                "category": {
                    ...
                    "url": product.category.get_absolute_url(),  # Генерация абсолютного URL категории
                },
