...
MIGRATION_MODULES = {"sites": "smartpick.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "config.middleware.DynamicURLMiddleware",  # Динамическое middleware
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "smartpick.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
CORS_ALLOWED_ORIGINS = [
    "http://smart-pick.local",
    "https://smart-pick.ru",
    "http://landing.smart-pick.local",
    "https://landing.smart-pick.ru",
    "https://asursoft.tech",
    "http://asursoft.local",
    "http://127.0.0.1",
    "http://localhost",
...
ADMINS = [("""ASURSOFT""", "asursoft@smart-pick.ru")]
...
LOGGING = {
    ...
    "loggers": {
        "django": {
            "handlers": ["console", "file"],
            "level": "INFO",  # В продакшен переключить на INFO
            "propagate": True,
        },
        "webpack_loader": {
            "handlers": ["console", "file"],
        ...
        "debug_toolbar": {  # Логгер для debug_toolbar
            "handlers": ["console", "file"],
            "level": "INFO",  # Логировать только ошибки
            "propagate": False,
        },
    },
}
...
ACCOUNT_FORMS = {"signup": "smartpick.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "smartpick.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "smartpick.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "smartpick API",
    "DESCRIPTION": "Documentation of API endpoints of smartpick",
    "VERSION": "1.0.0",
